...
export default function FaqModal({ onAdded }: FaqModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('Attempting to add FAQ to Firebase...');
      console.log('Data to be added:', {
        question: formData.feature.trim(),
        answer: formData.value.trim(),
      });
      ...
      let errorMessage = 'Error adding FAQ. Please try again.';
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          <label className="block text-white font-bold text-[48px]">Heading</label>
          <input
            type="text"
            name="feature"
        ...
        <div className="space-y-2">
          <label className="block text-white font-bold text-[20px]">Description</label>
          <input
            type="text"
            name="value"
